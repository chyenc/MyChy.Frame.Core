...
using MyChy.Frame.Core.EFCore.UnitOfWork.Exceptions;
using System;
...
namespace MyChy.Frame.Core.EFCore.UnitOfWork
{
    ...
    public abstract class EFCoreUnitOfWork<TDbContext> : ScopeEnabledUnitOfWork, 
        IEFCoreUnitOfWork<TDbContext>, IDisposable
